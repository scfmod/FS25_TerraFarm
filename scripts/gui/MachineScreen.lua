...
MachineScreen.XML_FILENAME = g_modDirectory .. 'data/gui/MachineScreen.xml'
...
function MachineScreen:load()
    ...
    self.areaSettingsFrame = MachineSettingsAreaFrame.new(self)
    ...
    g_gui:loadGui(MachineSettingsAreaFrame.XML_FILENAME, MachineSettingsAreaFrame.CLASS_NAME, self.areaSettingsFrame, true)
...
function MachineScreen:onGuiSetupFinished()
    ...
    self.areaSettingsFrame:initialize()
