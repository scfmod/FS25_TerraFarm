...
---@nodiscard
function LandscapingInputPaint.new(workArea, terrainLayerId)
    local self = LandscapingInput.new(LandscapingOperation.PAINT, workArea, terrainLayerId, nil, LandscapingInputPaint_mt)
